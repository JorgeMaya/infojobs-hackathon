	...
	return (
		<div className="container px-6 py-10 mx-auto">
			<div className="lg:flex lg:items-center">
				<div className="w-full space-y-12 lg:w-full ">
					<div>
						<Flex justifyContent="between">
						<img
								className="w-[5rem] h-[5rem] object-cover xl:w-[10rem] xl:h-[10rem] rounded-full -mt-10"
								...
								alt=""
							/>
						<Title className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl ">
							Nombre <br /> Apellido
						</Title>
					...
					<div className="md:flex md:items-start md:-mx-4">
						...
						<div className="mt-4 md:mx-4 md:mt-0">
							<Text className="text-xl font-semibold text-gray-700 capitalize ">
