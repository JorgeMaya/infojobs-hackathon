...
const LogInComponent = () => {
	const { gitHubLogIn } = useContext(AppContext);
		...
		<>
			<div className="max-w-screen-xl bg-white shadow sm:rounded-lg flex justify-center flex-1">
				<div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
					...
					<Flex flexDirection="col" alignItems="center" className="mt-8">
						<Title className="text-2xl xl:text-3xl font-extrabold">
							Accede como Candidato
						</Title>
						<div className="my-1 border-b text-center">
								<div className="leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2">
									Debes acceder a GitHub y Udemy antes de continuar
								</div>
							</div> 
						<Flex flexDirection="col" className="w-full mt-8">
							<Flex flexDirection="col" alignItems="center">
								{/* <button onClick={googleLogIn} className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-sky-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
									...
									<span className="ml-4">Accede con Google</span>
								</button> */}
								...
								>
									...
									<span className="ml-4">Accede a GitHub</span>
								</button>
								...
								<button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-sky-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
									...
									<span className="ml-4">Accede a Udemy</span>
								</button>
								...
								<button onClick={() => window.open(
									...
									"_self"
								)} className="mt-5 tracking-wide font-semibold bg-sky-600 text-gray-100 w-full max-w-xs py-4 rounded-lg hover:bg-sky-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
									<svg
							...
							<div className="mx-auto max-w-xs">
								...
								/> 
								<button className="mt-5 tracking-wide font-semibold bg-sky-600 text-gray-100 w-full py-4 rounded-lg hover:bg-sky-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
									<svg
										className="w-6 h-6 -ml-2"
										fill="none"
										stroke="currentColor"
				...
				<div className="flex-1 bg-sky-100 text-center lg:flex">
					<div className="m-12 xl:m-16 w-full bg-[url('/img-speaking.png')] bg-contain bg-center bg-no-repeat"></div>
				</div>
			</div>
		</>
	);
